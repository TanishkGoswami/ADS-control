      ...
      <div className="w-full max-w-[460px] bg-white border border-[#eaedf1] rounded-[5px] p-8 sm:p-9 space-y-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-white border border-[#eaedf1] rounded-[5px] text-xs text-[#0f172a] placeholder-[#94a3b8] focus:outline-none focus:border-[#0064e0] focus:ring-1 focus:ring-[#0064e0] transition-colors"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-9 pr-9 py-2.5 bg-white border border-[#eaedf1] rounded-[5px] text-xs text-[#0f172a] placeholder-[#94a3b8] focus:outline-none focus:border-[#0064e0] focus:ring-1 focus:ring-[#0064e0] transition-colors"
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full py-2.5 px-4 bg-[#0064e0] hover:bg-[#0052b8] text-white rounded-[5px] text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer"
          >
            {isSubmitting ? (
              <>
